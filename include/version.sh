...
Openssl_Compat_Ver='openssl-1.1.1w'
Openssl_New_Ver='openssl-3.5.5'
Nghttp2_Ver='nghttp2-1.65.0'
...
Redis_Stable_Ver='redis-8.6.0'
PHPRedis_Ver='redis-6.2.0'
